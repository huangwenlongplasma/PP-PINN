...
if __name__ == '__main__':
    ...
    plt.legend()
    plt.savefig('fig/loss1_1tanh1.png')
    plt.savefig('fig/loss1_1tanh1.pdf')   
    plt.show()
    # 测试模型
    model.eval()
    ...
    plt.savefig('fig/lcr_error_1_1tanh1.png')
    plt.savefig('fig/lcr_error_1_1tanh1.pdf')
    plt.show()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/lcr_pred1_1tanh1.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/lcr_fp1_1tanh1.mat',
    ...
    def custom_formatter(x, pos):
        return "{:.1f}".format(x / 20)

    ax = plt.gca()  # 获取当前轴
    ax.yaxis.set_major_formatter(FuncFormatter(custom_formatter))
    ax.set_zlabel('u')
    plt.savefig('fig/lcr_pred_1_1tanh1.png')
    plt.savefig('fig/lcr_pred_1_1tanh1.pdf')
    plt.show()
    ...
    ax.yaxis.set_major_formatter(FuncFormatter(custom_formatter))
    ax.set_zlabel('u')
    plt.savefig('fig/lcr_real_1_1tanh1.png')
    plt.savefig('fig/lcr_real_1_1tanh1.pdf')
    plt.show()

    save_path = 'model/lcr1_1tanh1.pth'
