...
if __name__ == '__main__':
    ...
    plt.xlabel('t')
    plt.ylabel('x')
    plt.savefig('fig/lcr_error0.1.png')
    plt.show()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/lcr_pred0.1.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/lcr_fp0.1.mat',
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/lcr_pred_gy_0.1.png')
    plt.savefig('fig/lcr_pred_gy_0.1.pdf')
    plt.show()
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/lcr_real_gy_0.1.png')
    plt.savefig('fig/lcr_real_gy_0.1.pdf')
    plt.show()

    save_path = 'model/lcr0.1_1.pth'
