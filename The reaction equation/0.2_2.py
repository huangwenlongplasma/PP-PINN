...
if __name__ == '__main__':
    ...
    model_path = torch.load('model/lcr1_1tanh.pth')
    # 创建随机训练数据集
    num_samples = 1000
    ...
    data = scipy.io.loadmat('data/lcr_pred1_1tanh.mat')
    real = data['u']
    ...
    data = scipy.io.loadmat('data/lcr_fp1_1tanh.mat')
    x_fp = data['x']
    t_fp = data['t']
    ...
    plt.legend()
    plt.savefig('fig/loss1_20tanh.png')
    plt.savefig('fig/loss1_20tanh.pdf')
    plt.show()
    # 测试模型
    model.eval()
    ...
    plt.xlabel('t')
    plt.ylabel('x')
    plt.savefig('fig/lcr_error_1_20tanh.png')
    plt.savefig('fig/lcr_error_1_20tanh.pdf')
    plt.show()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/lcr_pred1_20tanh.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/lcr_fp1_20tanh.mat',
...
#     ax.set_zlabel('u', fontsize=16)
    ...
    # 自动调整子图参数
    plt.tight_layout()
    plt.savefig('fig/lcr_pred_1_20tanh.png')
#     plt.savefig('fig/lcr_pred_1_20tanh.pdf')
#     plt.savefig('fig/fm0.2pp-pinn.png')
#     plt.savefig('fig/fm0.2pp-pinn.pdf')
    plt.show()
...
#     ax.set_zlabel('u', fontsize=16)
    ...
    # 自动调整子图参数
    plt.tight_layout()
    plt.savefig('fig/lcr_real_1_20tanh.png')
#     plt.savefig('fig/lcr_real_1_20tanh.pdf')
    plt.show()

    save_path = 'model/lcr1_20tanh.pth'
