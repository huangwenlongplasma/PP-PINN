...
if __name__ == '__main__':
    ...
    plt.xlabel('t')
    plt.ylabel('x')
    plt.savefig('fig/lcr_error10.png')
    plt.show()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/lcr_pred10.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/lcr_fp10.mat',
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/lcr_pred_gy_10.png')
    plt.savefig('fig/lcr_pred_gy_10.pdf')
    plt.show()
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
#     plt.savefig('fig/lcr_real_10.png')
    # plt.savefig('fig/lcr_real_1_3d.pdf')
    plt.show()

    save_path = 'model/lcr1_10gy.pth'
