...
if __name__ == '__main__':
    ...
    data = scipy.io.loadmat('data/lcctanh20_fp9.mat')
    x_fp = data['x']
    t_fp = data['t']
...
#     cbar.ax.set_ylabel('Intensity', fontsize=12)  # 设置色标的标签大小
