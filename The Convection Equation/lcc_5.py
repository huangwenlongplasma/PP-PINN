...
if __name__ == '__main__':
    ...
    model_path = torch.load('model/lcctanh20_4.pth')
    # 创建随机训练数据集
    num_samples = 1000
    ...
    data = scipy.io.loadmat('data/lcctanh20_pred4.mat')
    real = data['u']
    ...
    data = scipy.io.loadmat('data/lcctanh20_fp4.mat')
    x_fp = data['x']
    t_fp = data['t']
    ...
    plt.legend()
    plt.savefig('fig/losstanh20_5.png')
#     plt.savefig('fig/losstanh20_5.pdf')
    plt.show()
    # 测试模型
    model.eval()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/lcctanh20_pred5.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/lcctanh20_fp5.mat',
    ...
    # plt.ylim(0, 2*np.pi)
    plt.title('pred')
    plt.savefig('fig/lcctanh_pred_5.png')
#     plt.savefig('fig/lcctanh_pred_5.pdf')
    plt.show()
    ...
    plt.ylabel('x')
    plt.title('real')
    plt.savefig('fig/lcctanh_real_5.png')
#     plt.savefig('fig/lcctanh_real_5.pdf')
    plt.show()

    save_path = 'model/lcctanh20_5.pth'
