...
if __name__ == '__main__':
    ...
    optimizer_lbfgs = torch.optim.LBFGS(model.parameters(), max_iter=20000, max_eval=None, tolerance_grad=0,
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/non_pred3_5_1.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/non_fp3_5_1.mat',
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/non_pred_3_5_1.png')
#     plt.savefig('fig/lcr_real_1_3d.pdf')
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/non_real_3_5_1.png')
    # plt.savefig('fig/lcr_real_1_3d.pdf')
    plt.show()

    save_path = 'model/non_3_5_1.pth'
