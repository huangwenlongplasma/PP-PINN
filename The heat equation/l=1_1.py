...
if __name__ == '__main__':
    ...
    plt.xlabel('t')
    plt.ylabel('x')
    plt.savefig('fig/non_error_1_1.png')
    plt.show()
    ...
    t = t.unsqueeze(1)
    solution = model(x, t)
    scipy.io.savemat('data/non_pred1_1.mat',
    ...
    u_fp = model(x, t_fp)
    scipy.io.savemat('data/non_fp1_1.mat',
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/non_pred_1_1.png')
#     plt.savefig('fig/lcr_real_1_3d.pdf')
    ...
    ax.set_ylabel('t')
    ax.set_zlabel('u')
    plt.savefig('fig/non_real_1_1.png')
    # plt.savefig('fig/lcr_real_1_3d.pdf')
    plt.show()

    save_path = 'model/non_1_1.pth'
